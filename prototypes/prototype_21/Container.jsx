...
import ToneSynthWithDropDown from './modules/ToneSynthWithDropDown.jsx'
...
export default class Container extends Component {
  ...
  componentDidMount() {
    ...
    document.addEventListener('click', this.handleSelectClose)
  }
  ...
  handleValueChange = (instrumentName, property, value) => {
    ...
    // else if (instrumentName === 'melody1' || instrumentName === 'melody2') {
    //   instrument1 = melodySynth1
    //   instrument2 = melodySynth2
    //   settings1 = melodySettings1
    //   settings2 = melodySettings2
    // }
  ...
  handleSelectOpen = () => {
    ...
    this.setState({
      selectWaveTypeOpen: true
    })
  }

  handleChangeWaveType = (instrumentName, property, value) => {
    const {
      melodySettings1,
      melodySettings2,
      bassSettings1,
    ...
    return (
      <div className="Header">
        ...
        <div className="toggleUIButton" onClick={this.handleToggleUIShow}>
          Show/Hide UI to reveal a new instrument
        </div>
      </div>
    )
  }
  ...
  render() {
    ...
    return (
      <div className="Frame noScrollBar">
